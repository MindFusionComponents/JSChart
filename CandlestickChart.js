define(["require", "exports", 'Scripts/MindFusion.Charting'], function (require, exports, m) {
    ...
    // series style
    chart.plot.seriesStyle = new Charting.CandlestickSeriesStyle(new Drawing.Brush("#ce0000"), new Drawing.Brush("#669acc"), new Drawing.Brush("#2d3956"), 2, Drawing.DashStyle.Solid, chart.plot.seriesRenderers.item(0));
