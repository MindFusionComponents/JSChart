define(["require", "exports", 'MindFusion.Common', 'MindFusion.Gauges'], function (require, exports, MindFusion_Common_1, g) {
    ...
    var speedometer = g.OvalGauge.create($('#speedometer')[0], false);
    ...
    var cyclometer = g.OvalGauge.create($('#cyclometer')[0], false);
    ...
    var batteryMeter = g.OvalGauge.create($('#batteryMeter')[0], false);
    ...
    var oilMeter = g.OvalGauge.create($('#oilMeter')[0], false);
    ...
    // fuelScale
    var fuelScale = new g.OvalScale(speedometer);
    ...
    // outer scale
    var outerScale = new g.OvalScale(speedometer);
    ...
    minorSettings.setShowTicks(false);
    // mph scale
    var mphScale = new g.OvalScale(speedometer);
    ...
    // batteryMeter
    // batteryScale
    var batteryScale = new g.OvalScale(batteryMeter);
    ...
    // oilMeter
    // oilScale
    var oilScale = new g.OvalScale(oilMeter);
...
//# sourceMappingURL=CarGauges.js.map