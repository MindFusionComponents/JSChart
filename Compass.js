define(["require", "exports", 'MindFusion.Common', 'MindFusion.Gauges'], function (require, exports, MindFusion_Common_1, g) {
    ...
    var compass = g.OvalGauge.create($('#compass')[0], false);
    ...
    var scale = new g.OvalScale(compass);
    ...
    // innerScale
    var innerScale = new g.OvalScale(compass);
    ...
    function onPrepaintScale(sender, args) {
        ...
        if (element.name == 'innerScale') {
            var figure = new g.PathFigure('M0.44, 0.5 L0.5, 0.15 L0.5, 0.85 L0.56, 0.5 Z');
    ...
    function onPaintPointer(sender, args) {
        ...
        var element = args.getElement();
        var size = element.getRenderSize();
        var figure = new g.PathFigure('M0.5, 0 L1, 0.5 L0.5, 1 Z');
