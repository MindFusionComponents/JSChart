...
let col1 = new Collections.ObservableCollection<m.MindFusion.Charting.Series>([smartphones, tablets, computers]);
...
var lineRenderer = new Charting.LineRenderer(new Collections.ObservableCollection<m.MindFusion.Charting.Series>(
...
{
	lineStyle.strokes = new Collections.List<m.MindFusion.Charting.Collections.List<m.MindFusion.Charting.Drawing.Brush>>([
...
lineStyle.commonFills = new Collections.List<m.MindFusion.Charting.Drawing.Brush>([
	googleBrush,
	new Drawing.Brush(Drawing.Color.knownColors.Purple),
...
// create a gauge
let ovalGauge = new Gauges.OvalGaugeRenderer(element);
...
function addToStack(stack: m.MindFusion.Charting.Components.StackPanel, text: string, brush: m.MindFusion.Charting.Drawing.Brush) {
