...
var gauge = g.OvalGauge.create(<HTMLCanvasElement>$('#gauge')[0], false);
...
function onPrepaintBackground(sender, args)
{
	...
	let baseShape = new g.PathFigure(figurePath);
	baseShape.setMargin(new g.Thickness(-widthExtent + 0.035, 0.095, -widthExtent + 0.035, 0.095));
	baseShape.setFill(g.Utils.createLinearGradient(45,
...
function onPrepaintForeground(sender, args)
{
	...
	figure1.setFill(g.Utils.createLinearGradient(90,
