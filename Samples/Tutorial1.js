define(["require", "exports", 'Scripts/MindFusion.Charting'], function (require, exports, m) {
    ...
    var data2 = new Charting.BarSeries(new Collections.List([13, 13, 14, 16, 23, 25, 20, 19, 16, 17, 15, 13, 13, 17, 18, 21]), null);
    data2.title = "CD";
    var data3 = new Charting.BarSeries(new Collections.List([29, 28, 29, 31, 33, 35, 33, 27, 28, 28, 27, 29, 29, 31, 33, 29]), null);
    data3.title = "MP3";
    ...
    lineRenderer.seriesStyle = new Charting.PerSeriesStyle(new Collections.List([
        ...
        new Drawing.Brush(Drawing.Color.fromArgb(0.6, 0, 255, 0))]), new Collections.List([
    ...
    bar3DDataRenderer.seriesStyle = new Charting.PerSeriesStyle(new Collections.List([
        new Drawing.Brush(Drawing.Color.fromArgb(0.6, 128, 0, 128)),
        new Drawing.Brush(Drawing.Color.fromArgb(0.6, 240, 230, 140)),
        new Drawing.Brush(Drawing.Color.fromArgb(0.6, 255, 165, 0))]), null, new Collections.List([1]));
    ...
    barOverlay3DRenderer.seriesStyle = new Charting.PerSeriesStyle(new Collections.List([
        ...
        new Drawing.Brush(Drawing.Color.fromArgb(0.6, 240, 230, 140)),
        new Drawing.Brush(Drawing.Color.fromArgb(0.6, 255, 165, 0))]), null, new Collections.List([1]));
    barStack3DRenderer.seriesStyle = new Charting.PerSeriesStyle(new Collections.List([
        new Drawing.Brush(Drawing.Color.fromArgb(0.6, 128, 0, 128)),
        new Drawing.Brush(Drawing.Color.fromArgb(0.6, 240, 230, 140)),
        new Drawing.Brush(Drawing.Color.fromArgb(0.6, 255, 165, 0))]), null, new Collections.List([1]));
    radarDataRenderer.seriesStyle = new Charting.PerSeriesStyle(new Collections.List([
        ...
        new Drawing.Brush(new Drawing.Color("PaleVioletRed"))]), new Collections.List([
        new Drawing.Brush(new Drawing.Color("PaleGreen")),
        new Drawing.Brush(new Drawing.Color("PaleTurquoise")),
