...
let series = new Collections.ObservableCollection<MindFusion.Charting.Series>(
	new Array<MindFusion.Charting.BarSeries>(
...
areaChart.plot.seriesStyle = new Charting.PerSeriesStyle(new Collections.List<MindFusion.Charting.Drawing.Brush>([firstBrush, secondBrush, thirdBrush]),
	new Collections.List<MindFusion.Charting.Drawing.Brush>([firstBrush, secondBrush, thirdBrush]), new Collections.List<number>([3.0, 3.0, 3.0]));
