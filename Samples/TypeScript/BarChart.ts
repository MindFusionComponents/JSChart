...
chart.plot.seriesStyle = new Charting.PerSeriesStyle(new Collections.List<MindFusion.Charting.Drawing.Brush>([firstBrush, secondBrush, thirdBrush]), null, new Collections.List<number>([1]));
