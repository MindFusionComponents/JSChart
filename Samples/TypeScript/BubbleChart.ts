...
let series3D1 = new Charting.PointSeries3D(
	new Collections.List<MindFusion.Charting.Point3D>
		([
...
let data = new Collections.ObservableCollection<MindFusion.Charting.Series>();
data.add(series3D1);
data.add(series3D2);
...
// series colors
chart.theme.commonSeriesFills = new Collections.List<MindFusion.Charting.Drawing.Brush>
	([
