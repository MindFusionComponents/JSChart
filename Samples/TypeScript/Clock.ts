...
let clock = Gauges.OvalGauge.create(document.getElementById('clock') as HTMLCanvasElement, false);
...
function updateTime()
{
	...
	let hourHand = clock.getElementByName("HourHand") as MindFusion.Gauges.Pointer;
	let minuteHand = clock.getElementByName("MinuteHand") as MindFusion.Gauges.Pointer;
	let secondHand = clock.getElementByName("SecondHand") as MindFusion.Gauges.Pointer;
