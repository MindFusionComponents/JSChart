...
barPlot.gridColor1 = new Charting.Drawing.Color("#dadada");
...
let col1 = new Collections.ObservableCollection<MindFusion.Charting.Series>([smartphones, tablets, computers]);
var barRenderer = new Charting.BarRenderer(col1);

let barStyle = new Charting.PerSeriesStyle();

barStyle.fills = barStyle.strokes = new Collections.List<MindFusion.Charting.Drawing.Brush>([
...
linePlot.gridColor1 = new Charting.Drawing.Color("#dadada");
...
var lineRenderer = new Charting.LineRenderer(new Collections.ObservableCollection<MindFusion.Charting.Series>(
...
{
	lineStyle.strokes = new Collections.List<MindFusion.Charting.Collections.List<MindFusion.Charting.Drawing.Brush>>([
		new Collections.List<MindFusion.Charting.Drawing.Brush>([
...
lineStyle.commonFills = new Collections.List<MindFusion.Charting.Drawing.Brush>([
	googleBrush,
	new Drawing.Brush(Drawing.Color.knownColors.Purple),
...
// create a gauge
let ovalGauge = new MindFusion.Charting.Gauges.OvalGaugeRenderer(element);
...
var scale = ovalGauge.gauge.scales[0] as MindFusion.Gauges.OvalScale;
...
legendLine.content = new Collections.ObservableCollection<MindFusion.Charting.SeriesRenderer>([lineRenderer]);
...
legendBar.content = new Collections.ObservableCollection<MindFusion.Charting.SeriesRenderer>([barRenderer]);
...
function addToStack(stack: MindFusion.Charting.Components.StackPanel, text: string, brush: MindFusion.Charting.Drawing.Brush) {
