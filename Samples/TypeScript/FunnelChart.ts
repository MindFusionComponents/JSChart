...
let brushes = new Collections.List<MindFusion.Charting.Drawing.Brush>(
	[
...
let strokes = new Collections.List<MindFusion.Charting.Drawing.Brush>(
    [
        new Drawing.Brush("#FFFFFF")
    ]);

let seriesBrushes = new Collections.List<MindFusion.Charting.Collections.List<MindFusion.Charting.Drawing.Brush>>();
seriesBrushes.add(brushes);
let seriesStrokes = new Collections.List<MindFusion.Charting.Collections.List<MindFusion.Charting.Drawing.Brush>>();
...
let seriesThicknesses = new Collections.List<MindFusion.Charting.Collections.List<number>>();
...
let seriesList = new Collections.ObservableCollection<MindFusion.Charting.Series>();
