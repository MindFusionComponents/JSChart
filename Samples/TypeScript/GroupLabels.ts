...
// create sample data
var series = new Collections.ObservableCollection<MindFusion.Charting.Series>();
for (let i = 0; i < 4; i++)
{
    if (i == 0)
    {
...
// create labels data
var annotations = new Collections.ObservableCollection<MindFusion.Charting.Series>();
...
{
    let fills = new Collections.List<MindFusion.Charting.Drawing.LinearGradientBrush>();
