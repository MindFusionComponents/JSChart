...
pieChart.theme.seriesStrokeThicknesses = new Collections.List<MindFusion.Charting.Collections.List<number>>([new Collections.List<number>([15])]);
...
function getSeriesCollection(): MindFusion.Charting.Collections.ObservableCollection<MindFusion.Charting.Series> 
{
	let collection = new Collections.ObservableCollection<MindFusion.Charting.Series>();
	for (let i = 0; i < 3; i++)
	{
		if (i == 0) {
...
function getBarFills(): MindFusion.Charting.Collections.List<MindFusion.Charting.Drawing.Brush>
{
	var fills = new Collections.List<MindFusion.Charting.Drawing.Brush>();
...
function getPieFills(): MindFusion.Charting.Collections.List<MindFusion.Charting.Collections.List<MindFusion.Charting.Drawing.Brush>>
{
	var fills = new Collections.List<MindFusion.Charting.Collections.List<MindFusion.Charting.Drawing.Brush>>();

	fills.add(new Collections.List<MindFusion.Charting.Drawing.Brush>([
