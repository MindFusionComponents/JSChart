...
style.commonFills = new Collections.List<MindFusion.Charting.Drawing.Brush>([firstBrush, secondBrush, thirdBrush]);
style.commonStrokes = new Collections.List<MindFusion.Charting.Drawing.Brush>([firstBrush, secondBrush, thirdBrush]);
