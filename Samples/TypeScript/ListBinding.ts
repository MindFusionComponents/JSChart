...
let plot = <MindFusion.Charting.RadarPlot>radarChart.plot;
...
(<MindFusion.Charting.DataBoundSeries>radarChart.series.item(0)).title = "age range 7-10";
(<MindFusion.Charting.DataBoundSeries>radarChart.series.item(1)).title = "age range 11-13";
(<MindFusion.Charting.DataBoundSeries>radarChart.series.item(2)).title = "age range 14-17";
...
radarChart.theme.commonSeriesFills = radarChart.theme.commonSeriesStrokes = new Collections.List<MindFusion.Charting.Drawing.Brush>
	([
...
function createData(): MindFusion.Charting.Collections.List<StudentData>
{
