...
let Collections = Charting.Collections;
let Drawing = Charting.Drawing;
...
// draw bars
var barRenderer = new Charting.BarRenderer(new Collections.ObservableCollection<MindFusion.Charting.Series>([barSeries]));
...
var lineRenderer = new Charting.LineRenderer(
				new Collections.ObservableCollection<MindFusion.Charting.Series>([lineSeries]));
...
var annotationRenderer = new Charting.AnnotationRenderer(new Collections.ObservableCollection<MindFusion.Charting.Series>([annotations]));
...
legendRenderer.content = new Collections.ObservableCollection<MindFusion.Charting.SeriesRenderer>([barRenderer, lineRenderer]);
