...
function getSeriesCollection(): MindFusion.Charting.Collections.ObservableCollection<MindFusion.Charting.Series> 
{
	...
	let s: MindFusion.Charting.Series2D;
...
function getFills(): MindFusion.Charting.Collections.List<MindFusion.Charting.Drawing.Brush>
{
	let fills = new Collections.List<MindFusion.Charting.Drawing.Brush>();
