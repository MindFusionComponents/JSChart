...
var barRenderer = new Charting.BarRenderer(
				new Collections.ObservableCollection<MindFusion.Charting.Series>([
...
plot1.seriesStyle = new Charting.PerSeriesStyle(new Collections.List<MindFusion.Charting.Drawing.Brush>([
...
plot2.seriesStyle = new Charting.PerSeriesStyle(new Collections.List<MindFusion.Charting.Drawing.Brush>
    ([
