...
let lineRenderer = new Charting.LineRenderer(new Collections.ObservableCollection<MindFusion.Charting.Series>([data1, data2, data3]));
let barDataRenderer = new Charting.BarRenderer(new Collections.ObservableCollection<MindFusion.Charting.Series>([data1, data2, data3]));
let radarDataRenderer = new Charting.RadarRenderer(new Collections.ObservableCollection<MindFusion.Charting.Series>([data1, data2, data3]));
let pieDataRenderer = new Charting.PieRenderer(data1, 1);
let bar3DDataRenderer = new Charting.BarRenderer3D(new Collections.ObservableCollection<MindFusion.Charting.Series>([data1, data2, data3]));
let horizontalBar3DDataRenderer = new Charting.BarRenderer(new Collections.ObservableCollection<MindFusion.Charting.Series>([data1, data2, data3]));
let barStack3DRenderer = new Charting.BarStackRenderer3D(new Collections.ObservableCollection<MindFusion.Charting.Series>([data1, data2, data3]));
let barOverlay3DRenderer = new Charting.BarOverlayRenderer3D(new Collections.ObservableCollection<MindFusion.Charting.Series>([data1, data2, data3]));
