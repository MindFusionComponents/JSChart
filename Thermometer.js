define(["require", "exports", 'MindFusion.Common', 'MindFusion.Gauges'], function (require, exports, MindFusion_Common_1, g) {
    ...
    var Range = g.Range;
    var gauge = g.LinearGauge.create($('#gauge')[0], false);
    ...
    function onPrepaintBackground(sender, args) {
        ...
        rect.setFill(g.Utils.createLinearGradient(45, [0, '#9a9a9a', 0.6, '#212121']));
        rect.setStroke('rgba(255,255,255,0.1)');
        args.paintVisualElement(rect, size);
        var rect2 = new g.RoundRectangle();
    ...
    function onPrepaintForeground(sender, args) {
        ...
        rect.setRoundness(20);
        rect.setMargin(new g.Thickness(3, 3, 3, 3, false));
        rect.setFill(g.Utils.createLinearGradient(45, [0.2, 'rgba(255,255,255,0.18)', 0.6, 'rgba(255,255,255,0)']));
        args.paintVisualElement(rect, size);
    }
    function onPrepaintScale(sender, args) {
        ...
        var element = args.getElement();
        var size = element.getRenderSize();
        var el = new g.Ellipse();
        el.setMargin(new g.Thickness(0.35, 0.9, 0.35, 0.01, true));
        el.setFill(g.Utils.createRadialGradient(null, null, [0, '#990000', 1, '#ff6666'], null, null));
        el.setStroke('white');
